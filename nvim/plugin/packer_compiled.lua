...
_G.packer_plugins = {
  ["coc.nvim"] = {
    loaded = true,
    path = "/home/jan/.local/share/nvim/site/pack/packer/start/coc.nvim",
  ...
  ["nvim-transparent"] = {
    loaded = true,
    path = "/home/jan/.local/share/nvim/site/pack/packer/start/nvim-transparent",
  ...
  ["vim-numbertoggle"] = {
    loaded = true,
    path = "/home/jan/.local/share/nvim/site/pack/packer/start/vim-numbertoggle",
    url = "https://github.com/jeffkreeftmeijer/vim-numbertoggle"
  },
  ["vim-polyglot"] = {
    loaded = true,
    path = "/home/jan/.local/share/nvim/site/pack/packer/start/vim-polyglot",
